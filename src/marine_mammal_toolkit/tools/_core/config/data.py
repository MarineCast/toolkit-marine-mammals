...
from marine_mammal_toolkit.tools._core.config.document import ConfigDocument
from marine_mammal_toolkit.tools._core.config.paths import resolve_config_include

DEFAULT_DOMAIN_CONFIG_KEYS = ("WHALE_LAYER",)
DOMAIN_CONFIG_KEYS = ("WHALE_LAYER",)
